...
class Appointments extends Component{
    ...
    handleAppointmentSubmit = (event) => {
        event.preventDefault()
            ...
            let visit_age = event.target.appointment_visit_age.value ? event.target.appointment_visit_age.value : event.target.appointment_visit_age.defaultValue
        ...
        return(
            <div>
                ...
                {this.state.sortBy === "Children" ?
                    <AppointmentsByChild children={this.state.children} handleAppointmentSubmit={this.handleAppointmentSubmit} handleAppointmentChange={this.handleAppointmentChange} handleAppointmentEdit={this.handleAppointmentEdit}/>
                    :
                    <AppointmentsByAppointment children={this.state.children} appointments={this.state.appointments} handleAppointmentSubmit={this.handleAppointmentSubmit} handleAppointmentChange={this.handleAppointmentChange} handleAppointmentEdit={this.handleAppointmentEdit}/>
                }
            </div>
        )
    }
